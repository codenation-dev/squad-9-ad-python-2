...
class Address(models.Model):
    ...
    street = models.CharField(verbose_name="Logradouro",
                              null=False,
                              blank=False,
                              max_length=150)
    number = models.CharField(verbose_name="Numero",
                              ...
                              blank=True,
                              max_length=10)
    complement = models.CharField(verbose_name="Complemento",
                                  null=True,
                                  blank=True,
                                  max_length=150)
    ...
    def __str__(self):
        if self.complement is not None:
            address_str = self.street + self.number + self.complement
        else:
            address_str = self.street + self.number
        return address_str
